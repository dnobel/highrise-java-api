...
public class SimpleXmlHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
    ...
    /**
     * Construct a new {@code SimpleXmlHttpMessageConverter} with a default
     * {@link Serializer}. Sets the
     ...
     * <p>
     * Setting a custom-configured {@code Serializer} is one way to take further
